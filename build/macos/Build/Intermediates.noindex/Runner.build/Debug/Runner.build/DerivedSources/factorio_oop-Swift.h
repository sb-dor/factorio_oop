...
#ifndef FACTORIO_OOP_SWIFT_H
#define FACTORIO_OOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="factorio_oop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12factorio_oop11AppDelegate")
...
SWIFT_CLASS("_TtC12factorio_oop17MainFlutterWindow")
